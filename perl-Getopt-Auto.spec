...
poleceń itp. Nawet z użyciem Getopt::Long lub ekwiwalentu, nadal trzeba
przekierowywać odpowiednie polecenia do właściwych funkcji, pisać
obsługę --help i --version itd. Ten moduł umożliwia wyabstrahowanie
tego kodu, pozwalając skoncentrować się na części funkcjonalnej.
